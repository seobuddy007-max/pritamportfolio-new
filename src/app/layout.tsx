...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Pritam Chatterjee", url: "https://www.pritamchatterjee.com" }],
  metadataBase: new URL("https://www.pritamchatterjee.com"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
  ...
  verification: {
    google: "m51Phh8w83xkgA0rhrN4cOh8ByyyoYcu4xSgeeXYGmA",
  },
};
